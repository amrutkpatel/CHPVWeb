      ...
      <div className="grid-layout">
        <div className="glass-panel">
          ...
          <p>
            ...
            <strong>{translate('genome', language)}:</strong> {translate('genome_details', language)}<sup><a href="#ref-7">[7]</a></sup><br/>
            <strong>{translate('morphology', language)}:</strong> {translate('morphology_details', language)}<sup><a href="#ref-16">[16]</a></sup>
          </p>
        ...
        <div className="glass-panel">
          <h3>{translate('genome_organization', language)}<sup><a href="#ref-7">[7]</a></sup></h3>
        ...
        <div className="glass-panel" style={{flexBasis: '100%'}}>
          ...
          <p>
            {translate('neurotropic_desc', language)}<sup><a href="#ref-8">[8]</a></sup>
          </p>
        </div>
      </div>
    </section>
